...
public class BeautyWaiterModeLaunchFragment extends BasicFragment implements AdapterView.OnItemClickListener {
    ...
    private List<AppContent> getApps() {
        ...
        listApps.add(new AppContent("提成兑换", BeautyMainActivity.PAGE_SHOP_MANAGE, R.drawable.icon_launch_shop));
        listApps.add(new AppContent("个人中心", BeautyMainActivity.PAGE_REPORT_CENTER, R.drawable.icon_launch_report));
