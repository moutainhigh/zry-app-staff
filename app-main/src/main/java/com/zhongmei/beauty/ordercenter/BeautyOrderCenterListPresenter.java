...
import com.zhongmei.bty.cashier.ordercenter.presenter.OrderCenterListPresenter;
...
public class BeautyOrderCenterListPresenter extends OrderCenterListPresenter {
    ...
    public BeautyOrderCenterListPresenter(IOrderCenterListView view) {
        super(view, new BeautyOrderCenterListManager());
    }
    ...
    public List<FilterData> getFilterData() {
        ...
        FilterData filterData = new FilterData(BaseApplication.sInstance.getString(R.string.order_type));
        filterData.addItem(new android.util.Pair<String, ValueEnum>(BaseApplication.sInstance.getString(R.string.order_here), DeliveryType.HERE));
        filterData.addItem(new android.util.Pair<String, ValueEnum>(BaseApplication.sInstance.getString(R.string.order_carry), DeliveryType.CARRY));
        filterData.addItem(new android.util.Pair<String, ValueEnum>(BaseApplication.sInstance.getString(R.string.order_send), DeliveryType.SEND));
        filterData.addItem(new android.util.Pair<String, ValueEnum>(BaseApplication.sInstance.getString(R.string.order_take), DeliveryType.TAKE));
        filterDatas.add(filterData);

        filterData = new FilterData(BaseApplication.sInstance.getString(R.string.order_source));
