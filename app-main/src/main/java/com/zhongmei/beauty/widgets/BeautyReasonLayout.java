...
import com.zhongmei.beauty.adapter.BeautyReasonAdapter;
...
public class BeautyReasonLayout extends LinearLayout implements OnFinishComposingListener {
    private static final String TAG = BeautyReasonLayout.class.getName();
    ...
    private BeautyReasonAdapter adapter;
    ...
    public BeautyReasonLayout(Context context) {
        super(context);
    }

        public BeautyReasonLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initUtil();
        mContext = context;
        LayoutInflater inflater = LayoutInflater.from(context);
                main_content = (LinearLayout) inflater.inflate(R.layout.beauty_order_center_operate_dialog_fragment_reason, null);
    ...
    public BeautyReasonLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initListview() {
        adapter = new BeautyReasonAdapter(mContext, reasonList);
