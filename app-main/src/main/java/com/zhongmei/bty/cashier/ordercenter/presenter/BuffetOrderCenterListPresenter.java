...
import com.zhongmei.bty.cashier.ordercenter.manager.BuffetOrderCenterListManager;
...
public class BuffetOrderCenterListPresenter extends OrderCenterListPresenter {
    ...
    public BuffetOrderCenterListPresenter(IOrderCenterListView view) {
        super(view, new BuffetOrderCenterListManager());
    }
