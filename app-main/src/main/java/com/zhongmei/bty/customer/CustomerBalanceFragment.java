...
//							CustomerPrintManager.getInstance().rePrinCardOrtMemberConsume(mCustomer.customerName , mCustomer.sex + "" , mCustomer.mobile ,
//									history.getCardNum() , authUser , history.getCreateDateTime() ,new BigDecimal(10) , new BigDecimal(10) ,new BigDecimal(10) , new BigDecimal(10) ,
