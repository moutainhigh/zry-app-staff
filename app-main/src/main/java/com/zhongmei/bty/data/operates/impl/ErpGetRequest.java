...
public class ErpGetRequest<E> extends GetGsonRequest<ErpResponseObject<E>> {

    private static final String TAG = ErpGetRequest.class.getSimpleName();
 ...
 *//*
    ...
    public ErpGetRequest(String url, Type responseType, Response.Listener<ErpResponseObject<E>> listener, Response.ErrorListener errorListener) {
        super(Method.GET,url, responseType, listener, errorListener);
 ...
 *//*
    ...
    public static class ErpGetExecutor<E> {

        public static <E> ErpGetExecutor<E> create(String url) {
            return new ErpGetExecutor<E>(url);
        }

        private ErpGetRequest<E> request;
        ...
        private ErpGetExecutor(String url) {
            this.mUrl = url;
            this.mProcessor = null;
        }

        public ErpGetExecutor<E> responseType(Type responseContentType) {
            this.mResponseContentType = responseContentType;
            return this;
        }

        public ErpGetExecutor<E> responseClass(Class<E> responseContentClass) {
            return responseType(getErpResponseType(Type.class.cast(responseContentClass)));
        }

        public ErpGetExecutor<E> responseProcessor(ErpResponseProcessor<E> processor) {
            this.mProcessor = processor;
            return this;
        }

        public ErpGetExecutor<E> timeout(int timeout) {
 ...
 *//*
        ...
        public void execute(ErpResponseListener<E> listener, Object tag) {
            ...
            try {
                request = new ErpGetRequest<E>(mUrl, mResponseContentType, listenerAdapter, errorListener);
