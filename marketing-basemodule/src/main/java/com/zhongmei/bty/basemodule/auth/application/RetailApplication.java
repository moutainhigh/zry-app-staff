...
public class RetailApplication extends AuthorizedApplication {
    ...
    public RetailApplication() {
        super(AuthorizedApplication.APP_CODE_RETAIL);
    }
    ...
    public void setTitle() {
        setTitle(R.string.retail_app_name);
    }

    @Override
    public void setIcon() {
        setIcon(R.drawable.retail_app_icon_selector);
    }

    @Override
    public void setLockIcon() {
        setLockIcon(R.drawable.retail_app_lock_icon);
    }
...
//		setActivityName("com.zhongmei.bty.retail.retail.RetailMainActivity");
        setActivityName(PathURI.URI_RETAIL);
    }
