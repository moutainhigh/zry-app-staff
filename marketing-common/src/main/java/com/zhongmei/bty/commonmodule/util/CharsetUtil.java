...
public class CharsetUtil {
    ...
    private static final String TAG = CharsetUtil.class.getSimpleName();
    ...
    private static Charset[] JAVA_CHARSETS = {
            new Charset("ISO8859_1", "ISO-8859-1", new String[]{
                    ...
                    "l1", "IBM819", "CP819", "csISOLatin1", "8859_1", "819",
                    "IBM-819", "ISO8859-1", "ISO_8859_1"}),
            new Charset("ISO8859_2", "ISO-8859-2", new String[]{
                    "ISO_8859-2:1987", "iso-ir-101", "ISO_8859-2", "latin2",
                    "l2", "csISOLatin2", "8859_2", "iso8859_2"}),
            new Charset("ISO8859_3", "ISO-8859-3", new String[]{
                    "ISO_8859-3:1988", "iso-ir-109", "ISO_8859-3", "latin3",
                    "l3", "csISOLatin3", "8859_3"}),
            new Charset("ISO8859_4", "ISO-8859-4", new String[]{
                    "ISO_8859-4:1988", "iso-ir-110", "ISO_8859-4", "latin4",
                    "l4", "csISOLatin4", "8859_4"}),
            ...
            new Charset("ISO8859_6", "ISO-8859-6", new String[]{
                    "ISO_8859-6:1987", "iso-ir-127", "ISO_8859-6", "ECMA-114",
            ...
            new Charset("Big5", "Big5", new String[]{"csBig5", "CN-Big5",
                    "BIG-FIVE", "BIGFIVE"}),
            new Charset("Big5_HKSCS", "Big5-HKSCS",
                    new String[]{"big5hkscs"}),
            new Charset("EUC_JP", "EUC-JP", new String[]{
                    "csEUCPkdFmtJapanese",
                    "Extended_UNIX_Code_Packed_Format_for_Japanese", "eucjis",
                    "x-eucjp", "eucjp", "x-euc-jp"}),
            new Charset("EUC_KR", "EUC-KR", new String[]{"csEUCKR",
            ...
            new Charset("EUC_CN", "GB2312", new String[]{"x-EUC-CN",
                    "csGB2312", "euccn", "euc-cn", "gb2312-80", "gb2312-1980",
                    "CN-GB", "CN-GB-ISOIR165"}),
            new Charset("GBK", "windows-936", new String[]{"CP936", "MS936",
                    "ms_936", "x-mswin-936"}),

            new Charset("Cp037", "IBM037",
                    new String[]{"ebcdic-cp-us", "ebcdic-cp-ca",
            ...
            new Charset("Cp858", "IBM00858", new String[]{"CCSID00858",
                    "CP00858", "PC-Multilingual-850+euro"}),
            ...
            new Charset("Cp1140", "IBM01140", new String[]{"CCSID01140",
                    "CP01140", "ebcdic-us-37+euro"}),
            new Charset("Cp1141", "IBM01141", new String[]{"CCSID01141",
                    "CP01141", "ebcdic-de-273+euro"}),
            ...
            new Charset("ISO2022KR", "ISO-2022-KR",
                    new String[]{"csISO2022KR"}),
            ...
            new Charset("JIS_C6626-1983", "JIS_C6626-1983", new String[]{
                    "x-JIS0208", "JIS0208", "csISO87JISX0208", "x0208",
            ...
            new Charset("MS950", "windows-950",
                    new String[]{"x-windows-950"}),
    ...
    public static java.nio.charset.Charset getCharset(String charsetName) {
        ...
        try {
            ...
            Log.d(TAG, "Illegal charset " + charsetName + ", fallback to "
                    + defaultCharset + ": " + e);
            // Use default charset on exception
            return java.nio.charset.Charset.forName(defaultCharset);
        } catch (UnsupportedCharsetException ex) {
            Log.d(TAG, "Unsupported charset " + charsetName + ", fallback to "
                    + defaultCharset + ": " + ex);
            // Use default charset on exception
            return java.nio.charset.Charset.forName(defaultCharset);
        }
     ...
     * sb.append(" * </table>\n"); return sb.toString(); }
     *
     * public static void main(String[] args) { LogUtil.i(TAG,dumpHtmlTable());
     * }
     */
}
