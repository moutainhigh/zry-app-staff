 ...
 */
public class AutofitCheckBox extends CheckBox implements AutofitHelper.OnTextSizeChangeListener {
    ...
    public AutofitCheckBox(Context context, AttributeSet attrs, int defStyle) {
