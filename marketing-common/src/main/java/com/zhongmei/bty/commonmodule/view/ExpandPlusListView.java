...
public class ExpandPlusListView extends ExpandableListView implements
    ...
    protected void onLayout(boolean changed, int left, int top, int right,
        ...
        if (mHeaderView != null && mAdapter != null && state != mOldState) {
            ...
            mHeaderView.layout(getPaddingLeft(),
                    getPaddingTop(),
                    mHeaderViewWidth + getPaddingLeft(),
                    mHeaderViewHeight + getPaddingTop());
        }
    ...
    public void configureHeaderView(int groupPosition, int childPosition) {
        ...
        switch (state) {
            ...
            case PINNED_HEADER_PUSHED_UP: {
                ...
                int headerHeight = mHeaderView.getHeight() + getPaddingTop();
                ...
                if (mHeaderView.getTop() != y + getPaddingTop()) {
                    mHeaderView.layout(getPaddingLeft(), y + getPaddingTop(),
                            mHeaderViewWidth + getPaddingLeft(), mHeaderViewHeight
                                    + y + getPaddingTop());
                }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (mHeaderViewVisible && mAdapter != null && mAdapter.getGroupCount() > 0) {
