...
public class NewMemberIntegralInfoResp extends LoyaltyTransferResp<NewMemberIntegralInfoResp.LoyaltyResult> {
    ...
    class NewIntegralRecord {
        ...
        Long id;        Integer recordType;         Long beforeIntegral;
        Long addIntegral;
        Long endIntegral;
        Long createDateTime;
        Long modifyDateTime;
    ...
    public List<IntegralRecord> getMemberIntegral(List<NewIntegralRecord> result) {
        ...
        if (result != null && result.size() != 0) {
            for (NewIntegralRecord n : result) {
                ...
                record.setAggregateCount(String.valueOf(getResult().aggregateCount));
