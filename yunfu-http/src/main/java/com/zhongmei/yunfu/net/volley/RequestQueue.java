...
public class RequestQueue {
    public static final String VOLLEY_THREAD_NAME = "volley";
    ...
    public void start() {
        stop();                 mCacheDispatcher = new CacheDispatcher(mCacheQueue, mNetworkQueue,
                mCache, mDelivery);
        mCacheDispatcher.start();
            ...
            networkDispatcher.setName(VOLLEY_THREAD_NAME + i);
