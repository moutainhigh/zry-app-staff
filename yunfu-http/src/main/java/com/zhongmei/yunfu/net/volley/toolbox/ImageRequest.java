...
import com.zhongmei.yunfu.net.request.StatisticsRequest;
 ...
 * decoded Bitmap.
 */
public class ImageRequest extends StatisticsRequest<Bitmap> {
    /**
    ...
    @Override
    protected Response<Bitmap> parseNetworkResponse1(NetworkResponse response) {
    ...
    @Override
    protected void deliverResponse1(Bitmap response) {
