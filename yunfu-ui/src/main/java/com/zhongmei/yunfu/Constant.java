...
public class Constant {
    ...
    public static final String QINIU_BUCKET_NAME = "fy-onoslog";
    ...
    public static final String SP_PRINT_SERVICE_ERROR_ORDER = "print_service_error_order_list";
        ...
        public static final String SUPPORT_ONECODE_PAY = "allow_onecode_pay";        public static final String PRINT_SERVICE_PACKAGE_NAME = "com.demo.print";
